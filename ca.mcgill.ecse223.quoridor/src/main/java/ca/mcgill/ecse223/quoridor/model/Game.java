...
public class Game
{
  ...
  public enum GameStatus { Initializing, ReadyToStart, Running, Stopped, WhiteWon, BlackWon, Draw, Replay }
  ...
  public boolean setHasFinalResult(boolean aHasFinalResult)
  {
    boolean wasSet = false;
    hasFinalResult = aHasFinalResult;
    wasSet = true;
    return wasSet;
  }

  public boolean resetHasFinalResult()
  {
    boolean wasReset = false;
    hasFinalResult = getDefaultHasFinalResult();
    wasReset = true;
    return wasReset;
  }
  ...
  public boolean getDefaultHasFinalResult()
  {
    return false;
  }
  ...
  public String toString()
  {
    return super.toString() + "["+
            "hasFinalResult" + ":" + getHasFinalResult()+ "]" + System.getProperties().getProperty("line.separator") +
